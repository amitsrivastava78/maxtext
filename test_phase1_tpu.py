#!/usr/bin/env python3
"""
Test Phase 1 optimizations on TPU.
This script should be run on a TPU instance.

Usage:
  python test_phase1_tpu.py
"""
...
def main():
    ...
    if backend != "tpu":
        ...
        print("\nTo run on TPU:")
        print("  1. SSH into TPU instance")
        print("  2. Activate environment")
        print("  3. Run: python test_phase1_tpu.py")
        print()
